...
def import_by_path(dotted_path, error_prefix=""):
    ...
    """
    warnings.warn(
        "Function utils.import_by_path is deprecated in favor of "
    ...
    try:
        ...
        raise ImproperlyConfigured(
            "{}{} doesn't look like a module path".format(error_prefix, dotted_path)
        )
    try:
        module = import_module(module_path)
    except ImportError as err:
        msg = '{}Error importing module {}: "{}"'.format(error_prefix, module_path, err)
